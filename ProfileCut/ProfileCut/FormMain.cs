...
{
    public partial class FormMain : Form, IMHost
    {
        ...
        private int _createLevelButtons(Control owner, int depthTag, string text, int x)
        {
            ...
            b.Width = btnWidth;
            b.Top = l.Height;
            tableLayoutPanelButtons.Height = l.Width + b.Width;
            b.Height = btnWidth - l.Height;            
            ...
            b.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
            b.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
            splitContainerMain.SplitterDistance = splitContainerMain.Height - b.Height - l.Height - 13;
        ...
        {
            if (splitContainerOptimization.Panel1Collapsed)
                splitContainerOptimization.Panel1Collapsed = false;
            else
                splitContainerOptimization.Panel1Collapsed = true;
        }
